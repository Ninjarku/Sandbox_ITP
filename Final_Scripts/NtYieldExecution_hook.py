...
# generates machine codes instructions used to modify the original NtYieldExecution function in memory
def get_patch_code(func_addr):
    if ctypes.sizeof(ctypes.c_void_p) == 8:
        return b"\x48\xb8" + func_addr.to_bytes(8, byteorder='little') + b"\xFF\xE0" 
    else:
        return b"\xB8" + func_addr.to_bytes(4, byteorder='little') + b"\xFF\xE0"  
